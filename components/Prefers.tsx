...
/* Matnlar lugʻatdan (t.prefers.cards) shu tartibda olinadi */
...
function PreferCard({
  ...
  variant,
  tile,
}: CardStyle & { title: string; desc: string }) {
  return (
...
export default function Prefers() {
  ...
  return (
    <section
      id="nima-uchun-biz"
      className="section-page edge-fade-y relative scroll-mt-24 overflow-hidden pb-28 pt-14 sm:pb-40 sm:pt-20"
    >
      {/* ===== Fon nurlari (glow) — kartochkalar ortidan oʻtib turadi ===== */}
      {/* Butun sectionni qamrab oluvchi yashil asos — pastga tomon toʻyinadi */}
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute -inset-x-[12%] -bottom-[14%] top-0 bg-[radial-gradient(70%_58%_at_50%_92%,rgba(79,209,137,0.5),rgba(79,209,137,0)_72%)]"
      />
      {/* Chap chekka nuri */}
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute -left-[14%] top-[22%] h-[560px] w-[560px] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(79,209,137,0.58),rgba(79,209,137,0)_70%)] blur-2xl"
      />
      {/* Pastki-chap eng yorqin nuqta */}
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute -bottom-[10%] left-[10%] h-[520px] w-[700px] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(44,193,118,0.62),rgba(44,193,118,0)_72%)] blur-2xl"
      />
      {/* Oʻng chekka nuri — hero-canvas'ning moviy tumanini yashilga buradi */}
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute -right-[12%] top-[34%] h-[560px] w-[540px] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(79,209,137,0.6),rgba(79,209,137,0)_70%)] blur-2xl"
      />
      {/* Yuqori-chap yumshoq oreol */}
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute -left-[6%] -top-[8%] h-[380px] w-[380px] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(134,224,165,0.42),rgba(134,224,165,0)_70%)] blur-2xl"
      />
      {/* Limon-yashil urgʻu */}
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute left-[42%] bottom-[6%] h-[300px] w-[300px] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(190,230,60,0.24),rgba(190,230,60,0)_70%)] blur-2xl"
      />

      {/* ===== Sochilgan suyuq tomchilar ===== */}
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute left-[6%] top-[16%] hidden h-5 w-5 animate-liquid rounded-full bg-[radial-gradient(circle_at_32%_28%,rgba(255,255,255,0.9)_0%,rgba(190,230,60,0.5)_38%,rgba(79,209,137,0.55)_78%)] shadow-[0_3px_8px_rgba(11,43,28,0.16)] blur-[1px] sm:block"
        style={{ animationDuration: "5.5s" }}
      />
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute right-[7%] top-[12%] hidden h-3.5 w-3.5 animate-liquid rounded-full bg-[radial-gradient(circle_at_32%_28%,rgba(255,255,255,0.9)_0%,rgba(190,230,60,0.55)_38%,rgba(44,193,118,0.55)_78%)] shadow-[0_2px_6px_rgba(11,43,28,0.16)] sm:block"
        style={{ animationDelay: "1.1s", animationDuration: "4.5s" }}
      />
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute bottom-[9%] left-[3%] hidden h-4 w-4 animate-liquid rounded-full bg-[radial-gradient(circle_at_32%_28%,rgba(255,255,255,0.9)_0%,rgba(190,230,60,0.5)_38%,rgba(79,209,137,0.6)_78%)] shadow-[0_2px_5px_rgba(11,43,28,0.16)] sm:block"
        style={{ animationDelay: "2.2s", animationDuration: "6s" }}
      />
      <div
        aria-hidden
        className="decor-glow pointer-events-none absolute bottom-[14%] right-[4%] hidden h-6 w-6 animate-liquid rounded-full bg-[radial-gradient(circle_at_32%_28%,rgba(255,255,255,0.85)_0%,rgba(190,230,60,0.45)_38%,rgba(79,209,137,0.5)_78%)] shadow-[0_3px_8px_rgba(11,43,28,0.14)] blur-[1px] sm:block"
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 z-[1] h-[260px] fade-bottom-long sm:h-[360px]"
      />
      ...
      <div className="relative z-[2] mx-auto max-w-[1240px] px-5 sm:px-8">
        ...
        <Reveal className="relative mx-auto max-w-[1120px] text-center">
          ...
          <h2 className="font-display text-[26px] font-extrabold leading-[1.2] tracking-[-0.01em] text-ink sm:text-[34px] lg:text-[40px]">
            {t.prefers.title}{" "}
            <span className="font-normal">{t.prefers.titleSoft}</span>
          </h2>
        </Reveal>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-12 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
          {CARDS.map((card, i) => (
            <Reveal
              ...
              className="h-full"
            >
              <PreferCard {...card} {...t.prefers.cards[i]} />
            </Reveal>
          ))}
        </div>
      </div>
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 h-[130px] fade-bottom-soft"
      />
    </section>
  );
}

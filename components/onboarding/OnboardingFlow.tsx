  ...
  return (
    <span className="relative z-[2] grid h-[56px] w-[56px] shrink-0 place-items-center">
      ...
      <m.span
        ...
        animate={
          open && !reduce && !offscreen ? { opacity: [0.45, 1, 0.45], scale: [0.92, 1.1, 0.92] } : { opacity: 0 }
        }
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] flex items-start gap-3.5 lg:flex-col lg:items-center lg:gap-0">
        <m.span
          animate={reduce || offscreen || !open ? { y: 0 } : { y: [0, -4, 0] }}
  ...
  return (
    ...
    >
      ...
      <m.div
        ...
        animate={reduce || offscreen ? undefined : { x: [0, 30, 0], y: [0, 24, 0], scale: [1, 1.08, 1] }}
      ...
      <m.div
        ...
        animate={reduce || offscreen ? undefined : { x: [0, 24, 0], scale: [1, 1.06, 1] }}
        ...
        <div className="relative mx-auto max-w-[900px] text-center">
          ...
          >
            ...
            <span className="font-display text-[13.5px] font-bold text-ink">
              <m.span key={done} className="inline-block text-brand-600">
                {done}
              </m.span>
          ...
          >
            ...
            >
              <m.span
                ...
                animate={reduce || offscreen ? undefined : { scale: [1, 0.78, 1] }}

...
export default function FloatingCard({
  ...
  return (
    ...
    >
      <div className="group flex items-center gap-2.5 rounded-2xl border border-[color:var(--glass-border)] bg-surface/95 px-3 py-2.5 shadow-float backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_22px_44px_-16px_rgba(11,43,28,0.28)]">
